package com.msashop.order.adapter.in.messaging;
...
public class PaymentSagaKafkaConsumer {
    ...
    public void onMessage(String rawMessage, Acknowledgment ack) throws Exception {
        SagaConsumerSupport.consume(
                ...
                dlqTopic,
                consumerGroup,
                this::isOrderRelevantResultEvent,
                envelope -> handlePaymentResultUseCase.handle(
                        consumerGroup,
                        workerId,
                        claimTimeoutSeconds,
                        envelope
    ...
    private boolean isOrderRelevantResultEvent(String eventType) {
        return EventTypes.STOCK_RESERVATION_FAILED.equals(eventType)
